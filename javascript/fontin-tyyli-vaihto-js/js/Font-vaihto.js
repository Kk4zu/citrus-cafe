var clickCount = 1;
  function myFunction() {
    if (clickCount == 1) {
        ...
        document.getElementById("demo").style.fontFamily = "Mansalva";
        clickCount++;
    ...
    document.getElementById("result").innerHTML = "Fontti on " +  document.getElementById("demo").style.fontFamily;
